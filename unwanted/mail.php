...
$mail->setFrom('no-replay@gmail.com', 'Name SENDER');

$mail->addAddress('MAIL RECIVER');                                                  // Add a recipient

$mail->isHTML(true);                                                                // Set email format to HTML

$mail->Subject = 'Subject';
$mail->Body    ='This is the HTML message body <b>in bold!</b>';                    // HTML Email
$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';        // No HTML Email Support
...
// ---------------------------  Addtional Options For Sending Mail --------------------------- 
/*
