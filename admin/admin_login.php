                    ...
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <form class="form-signin">
                                ...
                                <input type="checkbox" id="rememberMe" style="margin-left: 3%;"><label for="rememberMe" style="padding-left: 2%; padding-bottom: 3%;">Remember me</label>
                                <button class="btn btn-lg btn-block text-uppercase" style="background-color: #000; color: #fff;" type="submit">Log in as admin</button>
                                <hr class="my-4">
