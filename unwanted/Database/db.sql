...
CREATE TABLE ADDRESS (
    ...
    FOREIGN KEY (AD_LOGIN_ID) REFERENCES LOGIN (LOGIN_ID)

);

CREATE TABLE COOKIE (

    COK_ID INT PRIMARY KEY AUTO_INCREMENT ,
    COK_LOGIN_ID VARCHAR(50) ,
    COK_VALUE VARCHAR(255) ,

    FOREIGN KEY (COK_LOGIN_ID) REFERENCES LOGIN (LOGIN_ID)
...
CREATE TABLE PRODUCT (
    ...
    FOREIGN KEY (PRD_IMG_ID) REFERENCES PRD_IMAGE (IMG_ID)
